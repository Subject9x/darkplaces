...
{ GAME_BATTLEMETAL,			GAME_NORMAL,			"battlemetal",			"-battlemetal",				"battleMETAL",				"battleMETAL",				"metaldata",	NULL,			"battleMETAL",		"battlemetal"			}, // COMMANDLINEOPTION: Game: -doombringer runs the game DOOMBRINGER
};
