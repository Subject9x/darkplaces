...
#define	MAX_EFFECTS				512 ///< limit on size of cl.effects
#define	MAX_BEAMS				512 ///< limit on size of cl.beams
#define	MAX_TEMPENTITIES		8192 ///< max number of temporary models visible per frame (certain sprite effects, certain types of CSQC entities also use this)
